...
const FEED_INTERACTIONS = [
    ...
    'TEXT_POST', 'LIKE_IMAGE', 'LIKE_POST', 'REPLY_POST',
    ...
    'VOTE_HOT_OR_NOT', 'SUBMIT_HOT_OR_NOT', 'PURCHASE_ZINE_RIGHTS', 'STEM_SPLIT',
    'EDIT_POST_METADATA', 'EDIT_SONG_METADATA', 'EDIT_ITEM'
];
