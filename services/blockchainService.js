...
class BlockchainService extends EventEmitter {
    ...
    addTransaction(txData) {
        ...
        const balanceRequired = !['FOLLOW_USER', 'PROFILE_UPDATE', 'THEME_UPDATE', 'SET_TOP_8', 'SHOUTBOX_POST', 'ADMIN_MINT', 'SUBMIT_HOT_OR_NOT', 'VOTE_HOT_OR_NOT', 'STORY_POST', 'REPOST_POST', 'TIMED_COMMENT'].includes(type);
