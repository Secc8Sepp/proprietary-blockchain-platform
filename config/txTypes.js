...
const SOCIAL_ACTIONS = [
    ...
    'CREATE_PLAYLIST', 'ADD_TO_PLAYLIST', 'UPDATE_PLAYLIST_DETAILS',
    'DELETE_PLAYLIST', 'REORDER_PLAYLIST_TRACKS', 'REPOST_POST',
    'DELETE_POST', 'LIKE_SONG', 'UNLIKE_SONG'
];
...
const BALANCE_EXEMPT_ACTIONS = [
    ...
    'STORY_POST', 'REPOST_POST', 'DELETE_POST', 'LIKE_SONG', 'UNLIKE_SONG',
    'CREATE_PLAYLIST', 'ADD_TO_PLAYLIST', 'UPDATE_PLAYLIST_DETAILS',
    'DELETE_PLAYLIST', 'REORDER_PLAYLIST_TRACKS'
];
